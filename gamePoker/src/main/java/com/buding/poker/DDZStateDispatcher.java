...
import com.buding.poker.ddz.DDZCardLogic;
...
public class DDZStateDispatcher extends GameStateDispatcher<MJDesk> {
    //准备阶段
    ...
    private ICardLogic mCardLogic = new DDZCardLogic();
