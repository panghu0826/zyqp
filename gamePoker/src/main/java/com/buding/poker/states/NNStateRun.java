 ...
 * @Description: 游戏状态
 */
public class NNStateRun extends PokerStateCommon {
    ...
    public void onNet(NetEvent event) {
        try {
            ...
            switch (p.getOperType()) {
                case NNGameOperPlayerActionSyn: {
                    NN.NNGameOperPlayerActionSyn.Builder gb = NN.NNGameOperPlayerActionSyn.newBuilder();
