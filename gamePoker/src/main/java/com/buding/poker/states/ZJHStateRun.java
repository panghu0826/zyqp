 ...
 * @Description: 游戏状态
 */
public class ZJHStateRun extends PokerStateCommon {
    ...
    public void onNet(NetEvent event) {
        try {
            ...
            switch (p.getOperType()) {
                case ZJHGameOperPlayerActionSyn: {
                    ZJH.ZJHGameOperPlayerActionSyn.Builder gb = ZJH.ZJHGameOperPlayerActionSyn.newBuilder();
