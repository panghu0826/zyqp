...
public class WeixinUtil {
	...
	public static Logger log = LogManager.getLogger(WeixinUtil.class);
	...
	public final static String JSAPI_TICKET = "https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token=TOKEN&type=jsapi";
	...
	public static AccessToken getJSTicket(String token) {
		AccessToken accessToken = null;

		String requestUrl = JSAPI_TICKET.replaceAll("TOKEN", token);
		JSONObject jsonObject = httpsRequest(requestUrl, "GET", null);
		// 如果请求成功
		if (null != jsonObject) {
			try {
	...
	public static JSONObject httpsRequest(String requestUrl,
		...
		try {
//			String str = HttpsUtil.getMethod(requestUrl, requestMethod, outputStr);
//			return JSONObject.fromObject(str.toString());
			...
			httpUrlConn.setReadTimeout(12000);
	...
	public static void main(String[] args) throws Exception {
		AccessToken acc = getAccessToken(ConstantWeChat.APPID, ConstantWeChat.APPSECRET);
		System.out.println(new Gson().toJson(acc));
	}
}