...
public class OAuthService {
	...
	public static Logger log = LogManager.getLogger(OAuthService.class);
	 ...
	 * @return oauth url
	 */
	public static String getOauthUrl(String redirectUrl,String charset,String scope, String appid){
		String url = "";
		try {
			url = OAUTH
					.replace("APPID", appid)
	 ...
	 */
	public static AccessTokenOAuth getOAuthAccessToken(String code, String appid, String sec) {
