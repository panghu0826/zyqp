            ...
            function get_cjdata() {
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        var nJson = {"grid": "2", "txt": "本次没中奖！分享获取更多的抽取机会！!"};
                        if (!json.flag) {
                        ...
                        nJson.amount = json.prizeAmount;
                        nJson.name = json.prizeName;

                        var prizeType = json.prizeType;
                        // 再抽一次
                        if (prizeType == 100) {
                            nJson.grid = "8";
                        } else if (prizeType == 1) {
